...
public class App extends PanguApplication {
    ...
    // static {
    // SORTED_PACKAGES = new String[]{"com.taobao.scan",
    // "com.taobao.taobao.home", "com.taobao.passivelocation",
    // "com.taobao.mytaobao", "com.taobao.wangxin", "com.taobao.allspark",
    // "com.taobao.search", "com.taobao.android.scancode",
    // "com.taobao.android.trade", "com.taobao.taobao.cashdesk",
    // "com.taobao.weapp", "com.taobao.taobao.alipay"};
    // // AUTOSTART_PACKAGES = new String[]{"com.taobao.login4android",
    // "com.taobao.taobao.home", "com.taobao.mytaobao", "com.taobao.wangxin",
    // "com.taobao.passivelocation", "com.taobao.allspark"};
    // // DELAYED_PACKAGES = new String[]{"com.taobao.scan",
    // "com.taobao.taobao.pluginservice", "com.taobao.legacy", "com.ut.share",
    // "com.taobao.taobao.map", "com.taobao.android.gamecenter",
    // "com.taobao.tongxue", "com.taobao.taobao.zxing", "com.taobao.labs"};
    // // START = 0;
    // }
    ...
    // try {
    // List access$000 = App.this.getBundleEntryNames(zipFile,
    // "lib/armeabi/libcom_", ".so");
    // if (access$000 != null && access$000.size() > 0 &&
    // App.this.getAvailableInternalMemorySize() < ((long) (((access$000.size()
    // * 2) * 1024) * 1024))) {
    ...
    // edit.putString("last_version_name",
    // App.this.getPackageInfo().versionName);
    // edit.commit();
    // if (zipFile != null) {
    //
    // zipFile.close();
    ...
    // System.out.println("Install & dexopt bundles in process " +
    // App.this.processName + " " + (System.currentTimeMillis() -
    ...
    // // }
    // // }
    // System.out.println("DexOpt delayed bundles in " +
    // (System.currentTimeMillis() - currentTimeMillis) + " ms");;
    // }
    ...
    // // if (!(bundle222 == null || App.this.contains(DELAYED_PACKAGES,
    // bundle222.getLocation()))) {
    ...
    // System.setProperty("BUNDLES_INSTALLED", "true");
    // App.this.notifyBundleInstalled();
    // System.err.println( "Install & dexopt bundles in process " +
    // App.this.processName + " " + (System.currentTimeMillis() -
    // currentTimeMillis) + " ms");
    // currentTimeMillis = System.currentTimeMillis();
    // // while (r3 < r8) {
    ...
    public void onCreate() {
        ...
        // RuntimeVariables.delegateClassLoader=new
        // DelegateClassLoader(getClassLoader());
        ...
        // this.processName = runningAppProcessInfo.processName;
        // }
        // if (runningAppProcessInfo.uid == myUid && runningAppProcessInfo.pid
        // != myPid) {
        ...
        // System.out.println( "Atlas safemode inited " +
        ...
        // }
        // System.out.println( "Atlas framework inited " +
        // (System.currentTimeMillis() - START) + " ms");
        // awbDebug=true;
        // if (this.awbDebug) {
        ...
        // // System.out.println("found external awb " +
        ...
        // this.resetForOverrideInstall =
        // String.valueOf(Globals.isMiniPackage()).equals(string);
        // System.out.println( "resetForOverrideInstall = " +
        // this.resetForOverrideInstall);
        ...
        // edit.commit();
        // }
        // // if (!(Versions.isDebug() || isLowDevice() ||
        // !ApkUtils.isRootSystem())) {
        // // properties.put("android.taobao.atlas.publickey",
        // "");
        ...
        //
        // if (i2 != 0 || packageInfo.versionCode > i3 ||
        // ((packageInfo.versionCode == i3 &&
        // !TextUtils.equals(packageInfo.versionName, string2)) ||
        // this.resetForOverrideInstall)) {
        // properties.put("osgi.init", "true");
        // i = 1;
        // }
        // }
        // System.out.println( "Atlas framework starting in process " +
        // this.processName + " " + (System.currentTimeMillis() - START) +
        // " ms");
        // Atlas.getInstance().startup();
        // System.out.println( "Atlas framework started in process " +
        // this.processName + " " + (System.currentTimeMillis() - START) +
        // " ms");;
        // packageInfo2 = getPackageInfo();
        // if (getPackageName().equals(this.processName) && i != 0) {
        // Coordinator.postTask(new AnonymousClass_1("ProcessBundles",
        // packageInfo2));
        // return;
        ...
        // Log.e(TAG,
        // "Could not set Globals.sApplication & Globals.sClassLoader !!!",
        // e222);
        // throw new
        // RuntimeException("Could not set Globals.sApplication & Globals.sClassLoader !!!",
        // e222);
        // }
        // }
    }
    ...
    private List<String> getBundleEntryNames(ZipFile zipFile, String str,
            String str2) {
    ...
    // String filterEntryName = filterEntryName(list,
    // SORTED_PACKAGES[i2].replace(".", "_"));
    ...
    private boolean processLibsBundle(ZipFile zipFile, String str) {
        ...
        File file2 = new File(new File(getFilesDir().getParentFile(), "lib"),
                str2);
                ...
                if (!bundleImpl.getArchive().isDexOpted()) {
                    try {
                        ...
                        try {
                            ...
                            Log.e("TaobaoApplication",
                                    "Error while dexopt >>>", e2);
                        }
                    }
                }
            }
